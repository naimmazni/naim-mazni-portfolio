    ...
    <Column maxWidth="m" gap="xl" paddingY="12" horizontal="center">
      ...
      <Column fillWidth horizontal="center" gap="m">
        <Column maxWidth="s" horizontal="center" align="center">
          ...
          {/* Availability Badge */}
          <RevealFx translateY="8" delay={0.4} fillWidth horizontal="center" paddingBottom="24">
            <Badge
              background="brand-alpha-weak"
              paddingX="16"
              paddingY="8"
            ...
            >
              <Row gap="8" vertical="center">
                <Text>🎓</Text>
                <Text>Open to Internship Opportunities</Text>
              </Row>
            </Badge>
          </RevealFx>

          {/* Statistics Section */}
          <RevealFx translateY="8" delay={0.5} fillWidth horizontal="center" paddingTop="32">
