...
import { ScrollToHash, CustomMDX, ImageCarousel } from "@/components";
...
export default async function Project({
  ...
  let post = getPosts(["src", "app", "projects", "content"]).find((post) => post.slug === slugPath);
  ...
  return (
    <Column as="section" maxWidth="m" horizontal="center" gap="l">
      ...
      {(post.metadata.link || post.metadata.github) && (
        <Row horizontal="center" gap="16" marginBottom="24" wrap>
          {post.metadata.link && (
            <Button
      ...
      {post.metadata.images.length > 0 && (
        <ImageCarousel images={post.metadata.images} title={post.metadata.title} />
      )}
